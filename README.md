...
**Full-Stack Developer** · CS Student @ ISIMS · Software & Web Manager @ Microsoft Tech Club ISIMS
...
I'm a self-taught developer who enjoys exploring different corners of IT. JavaScript is my main tool for building clear, functional web apps — and I make a habit of picking up new technologies to understand how systems connect. I sharpen my problem-solving skills through real, shipped projects.
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>💼 MTC-ISIMS Website</h3>
      <p><strong>Role:</strong> Full-Stack Web Developer</p>
      <p>Digital hub for MTC ISIMS — our university's tech club. Includes member management, event organization, and a student collaboration platform.</p>
      <p>
    ...
    <td width="50%" valign="top">
      <h3>🎯 DX Hackathon Website</h3>
      <p><strong>Role:</strong> Front-End Web Developer</p>
      <p>Interactive platform for the DX Hackathon. Responsive, accessible, and visually consistent — built to enhance participant engagement from registration to results.</p>
      <p>
        <img src="https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=nextdotjs&logoColor=white" />
        <img src="https://img.shields.io/badge/Tailwind_CSS-06B6D4?style=flat-square&logo=tailwind-css&logoColor=white" />
  ...
  <tr>
    <td width="50%" valign="top">
      <h3>📱 Tbibi Mobile App</h3>
      <p><strong>Role:</strong> Mobile Developer</p>
      <p>Patient appointment management app. Simplifies scheduling for healthcare providers and offers an intuitive booking flow for patients.</p>
      <p>
        <img src="https://img.shields.io/badge/Windev_Mobile-0055A4?style=flat-square&logoColor=white" />
      </p>
    </td>
    <td width="50%" valign="top">
      <!-- Future project slot -->
